...
(() => {
	...
	function i() {
		...
		$("<li/>", {class: "geofs-list-collapsible-item"}).html(`Save<div class="geofs-collapsible"> <fieldset>
			...
			<button class="save-btn mdl-button mdl-js-button mdl-button--raised" onclick="geofs.save.lp();" style="display:none;" tabindex="0">Load previous flight path</button>
			<button class="save-btn mdl-button mdl-js-button mdl-button--raised" onclick="geofs.save.lf();" style="display:none;" tabindex="0">Load previous flight plan</button>
			<span class="geofs-hideForApp geofs-hideForSchool" style="display: inline-block; margin: 10px 0px 15px 0px;"> <a href="https://github.com/meatbroc/geofs-save" target="_blank" rel="nofollow"><img src="https://raw.githubusercontent.com/meatbroc/geofs-save/refs/heads/main/images/github.png" style="margin: 10px 10px 10px 0px;height:28px;width:114px;"></a>For more information about autosave, visit the <a href="https://github.com/meatbroc/geofs-save" target="_blank" rel="nofollow">Github page here</a> </span>
